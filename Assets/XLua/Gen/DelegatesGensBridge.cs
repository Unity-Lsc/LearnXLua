...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Study05_CallFunction.CustomCall2))
			{
			    return new Study05_CallFunction.CustomCall2(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(Study05_CallFunction.CustomCall3))
			{
			    return new Study05_CallFunction.CustomCall3(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(Study05_CallFunction.CustomCall4))
			{
			    return new Study05_CallFunction.CustomCall4(__Gen_Delegate_Imp12);
			}
